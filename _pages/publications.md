...
* Journal papers
  ...
  * Wang, Wei$^{1}$1, **Songlei Jian**1$^{1}$\*, Yusong Tan\*, Qingbo Wu, and Chenlin Huang. "Representation Learning-based Network Intrusion Detection System by Capturing Explicit and Implicit Feature Interactions." Computers & Security (2021)  [[Paper]](http://jiansonglei.github.io/files/21comsec.pdf) 
