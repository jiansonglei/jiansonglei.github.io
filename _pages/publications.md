...
* Journal papers
  ...
  * Wang, Wei$^{1}$, **Songlei Jian**$^{1}$\*, Yusong Tan\*, Qingbo Wu, and Chenlin Huang. "Representation Learning-based Network Intrusion Detection System by Capturing Explicit and Implicit Feature Interactions." ($^{1}$equal contribution) Computers & Security (2021)  [[Paper]](http://jiansonglei.github.io/files/21comsec.pdf) 
...
* Conference papers
  * Ning Liu, **Songlei Jian**, Dongsheng Li, and Hongzuo Xu. "Unsupervised Hierarchical Graph Pooling via Substructure-Sensitive Mutual Information Maximization." 31st ACM International Conference on Information and Knowledge Management (CIKM ’22),[[Paper]](http://jiansonglei.github.io/files/22CIKM_SMIP.pdf)
